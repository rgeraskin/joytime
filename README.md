...
- **История**: просмотр истории токенов по ребёнку, постранично по 20 записей (навигация раньше/позже)
...
- **История**: просмотр своей истории токенов, постранично по 20 записей (навигация раньше/позже)
...
mise run release-rc <ver>   # Собрать и запушить RC-образ в Docker Hub
```
