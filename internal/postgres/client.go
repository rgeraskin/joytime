...
// func (db *DB) FamilyList(family *Families) error {
// 	logger := logger.With("function", "FamilyList")

// 	logger.Info("Getting family list...")
// 	var families []Families
// 	err := db.DB.Find(&families).Error
// 	if err != nil {
// 		return err
// 	}
// 	logger.Debug(fmt.Sprintf("Families: %v", families))
// 	return nil
// }

// func (db *DB) FamilyJoin(user *Users) error {
// 	logger := logger.
// 		With("function", "FamilyJoin")
